                        ...
                        <div class="card-body pt-4">
                            ...
                            <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                                <div class="navi-item mb-2">
                                    <a href="/EmployeeviewEmployeeAccount" class="navi-link py-4 ">
                                ...
                                <div class="navi-item mb-2">
                                    <a href="/EmployeeChangePassword" class="navi-link py-4">
															<span class="navi-icon mr-2">
																<span class="svg-icon">
                    ...
                    <div class="card card-custom">
                        ...
                        <div class="card-header py-3">
                            <div class="card-title align-items-start flex-column">
                                <h3 class="card-label font-weight-bolder text-dark"> بيانات الحساب</h3>
                                <span class="text-muted font-weight-bold font-size-sm mt-1">تغيير إعدادات حسابك الشخصي</span>
                            </div>
                            <div class="card-toolbar">
                                <button type="reset" class="btn btn-success mr-2">حفظ التعديلات</button>
                                <button type="reset" class="btn btn-secondary">تجاهل</button>
                            </div>
                        </div>
                        <!--end::Header-->
                        <!--begin::Form-->
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <h5 class="font-weight-bold mb-6">الحساب:</h5>
                                    </div>
                                </div>
                                <!--begin::Form Group-->
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <div class="spinner spinner-sm spinner-success spinner-right">
                                            <input class="form-control form-control-lg form-control-solid" type="text" value="عائشة ابراهيم دار " />
                                        </div>
                                    </div>
                                </div>
                                <!--begin::Form Group-->
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        ...
                                        <span class="form-text text-muted">البريد الالكتروني لن يتم عرضه علنا.

                                    </div>
                                </div>
                                <!--begin::Form Group-->
                                <div class="form-group row">
                                    <label class="col-xl-3 col-lg-3 col-form-label">اللغة</label>
                                    <div class="col-lg-9 col-xl-6">
                                ...
                                <!--begin::Form Group-->
                                <div class="form-group row">
                                    <label class="col-xl-3 col-lg-3 col-form-label">توقيت المنطقة</label>
                                    <div class="col-lg-9 col-xl-6">
                                        <select class="form-control form-control-lg form-control-solid">
                                ...
                                <div class="form-group row align-items-center">
                                    <label class="col-xl-3 col-lg-3 col-form-label">تواصل:</label>
                                    <div class="col-lg-9 col-xl-6">
                                        <div class="checkbox-inline">
                                            <label class="checkbox">
                                                <input type="checkbox" checked="checked" />البريد الالكتروني
                                                <span></span></label>
                                            <label class="checkbox">
                                                <input type="checkbox" checked="checked" />رسائل جوال
                                                <span></span></label>
                                            <label class="checkbox">
                                                <input type="checkbox" />رقم هاتف
                                                <span></span></label>
                                        </div>
                                    </div>
                                </div>
