    ...
    <div class="card card-custom card-custom gutter-t">
        ...
        <div class="card-header py-3">
            <div class="card-title">
                <h3 class="card-label">طلبات الإذن</h3>
            </div>
            <div class="card-toolbar">
                ...
                <button type="button" class="btn btn-light-primary font-weight-bolder "
                        ...
                        data-target="#UrgentRequest">
                    <span class="svg-icon svg-icon-md">

                    </span>تقديم طلب إذن مستعجل
                </button>
        ...
        <!--start: modal for show UrgentRequest-->
        <div class="modal fade" id="showUrgentModal_" tabindex="-1" role="dialog" aria-labelledby="exampleModalSizeLg"
             aria-hidden="true">
...
"/>
                                ...
                                <div class="form-group row mt-4">
                                    <label for="example-date-input" class="col-lg-1 col-form-label" style="    right: 9px;
">من:</label>
                                    <div class="col-4" style="
    right: 28px;
">
                                        <input class="form-control" type="time" value="11:00 am" id="example-date-input"/>
                                    </div>
                                    <label for="example-date-input" class="col-lg-1 col-form-label" style="
    right: 34px;
">إلى:</label>
                                    <div class="col-4" style="
    right: 27px;
">
                                        <input class="form-control" type="time" value="13:00 pm" id="example-date-input"/>
                                    </div>
...
">التفاصيل :</label>
                                    <div class="col-lg-8">
                                        <textarea class="form-control" rows="5" disabled="disabled" style="align-content: center;">أتقدم بإجازة مرضية</textarea>
        ...
        <!--end: modal for show UrgentRequest-->


        <!--start: modal for Add UrgentRequest-->
        <div class="modal fade" id="UrgentRequest" tabindex="-1" role="dialog" aria-labelledby="exampleModalSizeLg"
             aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">  طلب إذن مستعجل</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <i aria-hidden="true" class="ki ki-close"></i>
                        </button>
                    </div>
...
">التفاصيل :</label>
                                    <div class="col-lg-8">
                                        <textarea class="form-control" rows="5"  style="align-content: center;">أتقدم بإجازة مرضية</textarea>
        ...
        <!--end: modal for Add UrgentRequest-->
    </div>
