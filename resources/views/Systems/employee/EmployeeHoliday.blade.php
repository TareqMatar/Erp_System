    ...
    <div class="card card-custom card-custom gutter-t">
        ...
        <div class="card-header py-3">
            <div class="card-title">
                <h3 class="card-label">طلبات الإجــازة</h3>
            </div>
            <div class="card-toolbar">
                ...
                <button type="button" class="btn btn-light-primary font-weight-bolder "
                        ...
                        data-target="#HolidaysRequest">
                    <span class="svg-icon svg-icon-md">

                    </span>تقديم طلب إجازة
                </button>
...
">اسم الشركة:</label>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-auto col-form-label text-right" style="margin-left: 22px;
    padding-left: 0px;">نوع الإجازة :</label>
                                    <div class="col-lg-9">
                                        <select class="form-control" id="StatusService">

                                            <option selected>إجازة ساعية</option>
                                            <option>إجازة يومية</option>
                                            <option>إجازة أسبوعية</option>
                                            <option>إجازة شهرية</option>
...
">التفاصيل :</label>
                                    <div class="col-lg-8">
                                        <textarea class="form-control" rows="5" disabled="disabled"
                                                  style="align-content: center;">أتقدم بإجازة مرضية</textarea>
...
">
        ...
        <div class="modal fade" id="HolidaysRequest" tabindex="-1" role="dialog" aria-labelledby="exampleModalSizeLg"
             aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel"> تقديم طلب</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <i aria-hidden="true" class="ki ki-close"></i>
                        </button>
                    </div>
    ...
    padding-left: 0px;">نوع الإجازة :</label>
                                    <div class="col-lg-9">
                                        <select class="form-control" id="StatusService">
                                            ...
                                            <option selected>إجازة يومية</option>
                                            <option>إجازة أسبوعية</option>
                                            <option>إجازة شهرية</option>
                                            <option>إجازة سنوية</option>
