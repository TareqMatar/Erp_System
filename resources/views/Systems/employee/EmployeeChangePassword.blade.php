                    ...
                    <div class="card card-custom card-stretch">
                        ...
                        <div class="card-body pt-4">
                            ...
                            <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                                ...
                                <div class="navi-item mb-2">
                                    <a href="/EmployeeAcountInformation"
                                       class="navi-link py-4">
															<span class="navi-icon mr-2">
																<span class="svg-icon">
                        ...
                        <form class="form">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label class="col-xl-3 col-lg-3 col-form-label text-alert">كلمة المرور الحالية</label>
                                    <div class="col-lg-9 col-xl-6">
                                        <input type="password" class="form-control form-control-lg form-control-solid mb-2" value=""
                                               placeholder="Current password"/>
                                        <a href="#" class="text-sm font-weight-bold">نسيت كلمة  المرور ?</a>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label class="col-xl-3 col-lg-3 col-form-label text-alert">تأكيد كلمة المرور</label>
                                    <div class="col-lg-9 col-xl-6">
                                        <input type="password" class="form-control form-control-lg form-control-solid" value=""
