    ...
    <div class="card card-custom card-custom gutter-t">
        ...
        <div class="card-header py-3">
            <div class="card-title">
                <h3 class="card-label">طلبات الاستقالة</h3>
            </div>
                ...
                <tr>
                    ...
                    <td nowrap="nowrap">
                        <a href="#view" data-toggle="modal"
                           data-target="#showResignationModal_"
        ...
        <!--start: modal for show Resignation Modal_-->
        <div class="modal fade" id="showResignationModal_" tabindex="-1" role="dialog" aria-labelledby="exampleModalSizeLg"
             aria-hidden="true">
...
">
        ...
        <!--end: modal for show Resignation Modal_  -->


        <!--start: modal for Add Resignation-->
        <div class="modal fade" id="HolidaysRequest" tabindex="-1" role="dialog" aria-labelledby="exampleModalSizeLg"
             aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel"> تقديم طلب استقالة</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <i aria-hidden="true" class="ki ki-close"></i>
                        </button>
                    </div>
...
">الســـبب :</label>
                                <p>
                                    أتقدم إليكم بطلب استقال وذلك بسبب:
                                </p>
                                <div class="col-lg-8">
                                        <textarea class="form-control" rows="5"
                                                  style="align-content: center;">أتقدم لسيادتكم بقبول طلب استقالتي وذلك بسبب ...........................   </textarea>

                                </div>
                                <p>
                                    وتفضلوا بقبول طلبي مع فائق الاحترام.
                                </p>
                            </div>
