...
@section('content')
    <div class="card card-custom card-custom gutter-t">
        ...
        <div class="card-header py-3">
            <div class="card-title">
                <h3 class="card-label">رســــوم الخدمــات</h3>
            </div>
                ...
                <tr>
                    ...
                    <td nowrap="nowrap">
                        <a href="#view" data-toggle="modal"
                           data-target="#showServiceFeeModal_"
                           class="btn btn-sm btn-icon btn-light btn-hover-info mr-2" title="تفاصيل الرسوم">
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <div class="modal fade" id="showServiceFeeModal_" tabindex="-1" role="dialog"
             aria-labelledby="exampleModalSizeLg"
             aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">رسوم خدمات شركة ---- </h5>
