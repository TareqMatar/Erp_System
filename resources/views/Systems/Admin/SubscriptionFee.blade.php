...
@section('content')
    <div class="card card-custom card-custom gutter-t">
        ...
        <div class="card-header py-3">
            <div class="card-title">
                <h3 class="card-label">رســــوم اشتراك</h3>
            </div>
                ...
                <tr>
                    ...
                    <td nowrap="nowrap">
                        <a href="#view" data-toggle="modal"
                           data-target="#showSubscriptinoFeeModal_"
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <!--start: modal for show Subscriptino Fee Modal_-->
        <div class="modal fade" id="showSubscriptinoFeeModal_" tabindex="-1" role="dialog"
             aria-labelledby="exampleModalSizeLg"
             aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">رسوم اشتراك شركة ---- </h5>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7"
                                         style="
                                                     right: 292px;
">
                                        <button type="submit" class="btn btn-secondary">مطالبة</button>
        ...
        <!--end: modal for show Subscriptino Fee Modal-->
