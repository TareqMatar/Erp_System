...
@section('content')
    <div class="card card-custom card-custom gutter-t">
        ...
        <div class="card-header py-3">
            <div class="card-title">
                <h3 class="card-label">المصروفــات</h3>
            </div>
    ...
    margin-left: 22px;
    padding-left: 0px;
"> المبلغ المطلوب:</label>
                    <div class="col-lg-4">
                        <input class="form-control" type="text" value="200$" id="example-date-input" disabled="true" style="
    margin-right: 13px;
"/>
                    </div>
                </div>
...
"> المبلغ المدفوع:</label>
                    <div class="col-lg-4">
                        <input class="form-control" type="text" value="100$" id="example-date-input" style="
    margin-right: 13px;
" disabled="true"/>
                    </div>
                </div>
