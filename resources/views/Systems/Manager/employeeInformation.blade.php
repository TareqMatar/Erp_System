...
@section('content')
    <div class="card card-custom card-custom gutter-t">
        ...
        <div class="card-body">
            ...
            <span
                    ...
                    <td nowrap="nowrap">
                        <a href="#view" data-toggle="modal" data-target="#ShowEmployeeInfo"
                           class="btn btn-sm btn-icon btn-light btn-hover-info mr-2" title="عرض السيرة الذاتية">
                            <i class="icon-x1 text-primary text-primary-40 flaticon-avatar icon-primary">
                            </i>
                        </a>
                        <a href="#edit" class="btn btn-sm btn-icon btn-light btn-hover-bg-warning"
                           title="تعديل بيانات العمل">
                            <i class="icon-x1 text-primary text-primary-40 flaticon2-edit icon-primary">
                            </i>
                        </a>
    ...
    <div class="modal fade" id="ShowEmployeeInfo" tabindex="-1" role="dialog"
    ...
    left: 207px;">
                <div class="card-body">
                    <div >
                        <!--begin::Section-->
                        <h4 class="mb-10 font-weight-bold text-dark">عرض البيانات الشخصية</h4>
