                        ...
                        <li class="nav-item d-flex col flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0">
                            <a class="nav-link border py-10 d-flex flex-grow-1 rounded flex-column align-items-center"
                               data-toggle="pill" href="#tab_forms_widget_1">
                                ...
                                <span class="nav-text font-size-lg py-2 font-weight-bold text-center">{{"تقييم"}}</span>
                            </a>
                        </li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        ...
                        <li class="nav-item d-flex col flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0">
                            <a class="nav-link active border py-10 d-flex flex-grow-1 rounded flex-column align-items-center"
                               data-toggle="pill" href="#tab_forms_widget_3">
                                ...
                                <span class="nav-text font-size-lg py-2 font-weight-bolder text-center">{{"بوست"}}</span>
                            </a>
                        </li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="nav-item d-flex col flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0">
                            <a class="nav-link border py-10 d-flex flex-grow-1 rounded flex-column align-items-center"
                               data-toggle="pill" href="#tab_forms_widget_4">
                                ...
                                <span class="nav-text font-size-lg py-2 font-weight-bolder text-center">مشاركة</span>
                            </a>
                        </li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="nav-item d-flex col flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0">
                            <a class="nav-link border py-10 d-flex flex-grow-1 rounded flex-column align-items-center"
                               data-toggle="pill" href="#tab_forms_widget_5">
                                ...
                                <span class="nav-text font-size-lg py-2 font-weight-bolder text-center">{{"تعليق"}}</span>
                            </a>
                        </li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="nav-item d-flex col flex-grow-1 flex-shrink-0 mr-0 mb-3 mb-lg-0">
                            <a class="nav-link border py-10 d-flex flex-grow-1 rounded flex-column align-items-center"
                               data-toggle="pill" href="#tab_forms_widget_5">
                                ...
                                <span class="nav-text font-size-lg py-2 font-weight-bolder text-center">{{"إعجاب"}}</span>
                            </a>
                        </li>
                        <!--end::Item-->
                    </ul>
                    ...
                    <div class="d-flex align-items-start justify-content-start flex-grow-1 bg-light-warning p-8 card-rounded flex-grow-1 position-relative">
                        <div class="d-flex flex-column align-items-start flex-grow-1 h-100">
                            <div class="p-1 flex-grow-1">
                                ...
                                <p class="text-dark-50 font-weight-bold mt-3">Pay 0$ for the First
                                    Month</p>
                            </div>
                            <a href='#' class="btn btn-link btn-link-warning font-weight-bold">Create
                                Report
            ...
            <div class="card card-custom bg-light-success gutter-b card-stretch card-shadowless">
                ...
                <div class="card-header border-0">
                    ...
                    <div class="card-toolbar">
                        <div class="dropdown dropdown-inline">
                            <a href="#" class="btn btn-clean btn-hover-success btn-sm btn-icon"
                ...
                <div class="card-body pt-2">
                    ...
                    <div class="d-flex align-items-center mb-10">
                        ...
                        <div class="symbol symbol-40 symbol-light-white mr-5">
                            <div class="symbol-label">
                                <img src="assets/media/svg/avatars/004-boy-1.svg"
                    ...
                    <div class="d-flex align-items-center mb-10">
                        ...
                        <div class="symbol symbol-40 symbol-light-white mr-5">
                            <div class="symbol-label">
                                <img src="assets/media/svg/avatars/002-girl.svg"
                                     class="h-75 align-self-end" alt=""/>
                            </div>
                        </div>
                        <!--end::Symbol-->
                    ...
                    <div class="d-flex align-items-center mb-10">
                        ...
                        <div class="symbol symbol-40 symbol-light-white mr-5">
                            <div class="symbol-label">
                                <img src="assets/media/svg/avatars/008-boy-3.svg"
                                     class="h-75 align-self-end" alt=""/>
                            </div>
                        </div>
                        <!--end::Symbol-->
                ...
                <div class="card-header border-0">
                    ...
                    <div class="card-toolbar">
                        <div class="dropdown dropdown-inline" data-toggle="tooltip" title=""
                            ...
                            <a href="#"
                               class="btn btn-warning btn-sm font-weight-bolder font-size-sm dropdown-toggle"
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="d-flex align-items-center mb-6">
                        ...
                        <div class="d-flex flex-column flex-grow-1 py-2">
                            <a href="#"
                               class="text-dark-75 font-weight-bold text-hover-primary font-size-lg mb-1">Create
                                FireStone Logo</a>
                            <a href="#" class="text-muted font-weight-bold text-hover-primary">Due
                                in 2 Days</a>
                        </div>
                        <!--end::Text-->
                        <!--begin::Dropdown-->
                    ...
                    <div class="d-flex align-items-center mb-6">
                        ...
                        <div class="d-flex flex-column flex-grow-1 py-2">
                            <a href="#"
                               class="text-dark-75 font-weight-bold text-hover-primary font-size-lg mb-1">Stakeholder
                                Meeting</a>
                            <a href="#" class="text-muted font-weight-bold text-hover-primary">Due
                                in 3 Weeks</a>
                        </div>
                    ...
                    <div class="d-flex align-items-center mb-6">
                        ...
                        <div class="d-flex flex-column flex-grow-1 py-2">
                            <a href="#"
                               class="text-dark-75 font-weight-bold text-hover-primary font-size-lg mb-1">Scoping
                                &amp; Estimations</a>
                            <a href="#" class="text-muted font-weight-bold text-hover-primary">Due
                                in 8 Hours</a>
                        </div>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="d-flex flex-column flex-grow-1 py-2">
                            <a href="#"
                               class="text-dark-75 font-weight-bold text-hover-primary font-size-lg mb-1">Project
                                Retro</a>
                            <a href="#" class="text-muted font-weight-bold text-hover-primary">Due
                                in 1 Year</a>
                        </div>
                                    ...
                                    <div class="d-flex flex-column w-100 mr-2">
                                        ...
                                        <div class="progress progress-xs w-100">
                                            <div class="progress-bar bg-success" role="progressbar"
                                                 style="width: 83%;" aria-valuenow="50"
                                                 aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                    </div>
                                </td>
