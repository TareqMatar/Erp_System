    ...
    <div class="card card-custom card-custom gutter-t">
        ...
        <div class="card-header py-3">
            <div class="card-title">
                <h3 class="card-label">طلبات الخدمـــات</h3>
            </div>
        ...
        <div class="card-body">
            ...
            <table class="table table-bordered  table-hover table-checkable" id="kt_datatable2">
                ...
                <tr>
                    <th></th>
                    <th scope="col">#</th>
                    <th scope="col">اسم الشركـة</th>
                    <th scope="col"> اسم الخدمـة</th>
                ...
                <tr>
                    ...
                    <td>
                        <a href="#accebt" data-toggle="modal"
                           class="btn btn-sm btn-icon btn-light btn-hover-success mr-2" title="قبول">
                        ...
                        <a href="javascript:;" class="btn btn-sm btn-icon btn-light btn-hover-danger"
                           title="رفض الإعلان">
                            <i
                                    class="icon-x1 text-success text-success-40 flaticon2-delete  icon-success"></i>
                        </a>
