    ...
    <div class="card card-custom card-custom gutter-t">
        ...
        <div class="card-header py-3">
            <div class="card-title">
                <h3 class="card-label">الخدمـــــات</h3>
            </div>
            <div class="card-toolbar">
                ...
                <div class="dropdown dropdown-inline mr-2">
                    ...
                    <!--end::Dropdown Menu-->
                    <button  type="button" class="btn btn-light-primary font-weight-normal" style="
        height: 41.45px;
    width: 56px;
    padding-top: 0px;
">
                        <a href="#add" data-toggle="modal" data-target="#addCompanyModal"
                           class="btn btn-sm btn-icon btn-light btn-hover-primary mr-2" title="إضافة" style="

                                    margin-top: 9px;width: 28px;margin-left: 0px;height: 23px;padding-top: 0px;
                                      ">
        ...
        <div class="card-body">
            ...
            <table class="table table-bordered  table-hover table-checkable" id="kt_datatable2">
                ...
                <tr>
                    ...
                    <td>1</td>
                    <td>إعلان توظيف</td>
                    <td>يقوم بنشر اعلانات التوظيف ومتابعتها حتى النهاية</td>
                    <td>30$</td>
