    ...
    <div class="card card-custom card-custom gutter-t">
        ...
        <div class="card-header py-3">
            <div class="card-title">
                <h3 class="card-label">إعلانات التوظيــف</h3>
            </div>
        ...
        <div class="card-body">
            ...
            <table class="table table-bordered  table-hover table-checkable" id="kt_datatable2">
                ...
                <tr>
                    ...
                    <th scope="col">تاريخ استقبال الطلبات</th>
                    <th scope="col">تاريخ نهايةاستقبال الطلبات</th>
                    <th scope="col">آلية التوظيف</th>
                ...
                <tr>
                    ...
                    <td nowrap="nowrap">
                        <a href="#view" data-toggle="modal"
                           ...
                           class="btn btn-sm btn-icon btn-light btn-hover-info mr-2" title="عرض التفاصيل">
                            <i class="icon-x1 text-primary text-primary-40 flaticon-interface-11 icon-primary"></i>
                        </a>
