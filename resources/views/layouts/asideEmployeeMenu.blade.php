<!--begin::Aside-->
<div class="aside aside-left d-flex flex-column flex-row-auto" id="kt_aside"  style="">
    <!--begin::Aside Menu-->
        ...
        <div id="kt_aside_menu" class="aside-menu min-h-lg-800px" data-menu-vertical="1" data-menu-scroll="1"
            ...
            <ul class="menu-nav">
                ...
                <li class="menu-item" aria-haspopup="true">
                    <a target="_blank" href="/ManagerAccount"
                       class="menu-link">
									<span class="svg-icon menu-icon">
                        ...
                        <span class="menu-text">المعلومات الشخصية </span>
                    </a>
                </li>


                <li class="menu-section">
                    <h4 class="menu-text">إدارة السيرة الذاتية </h4>
                ...
                <li class="menu-item" aria-haspopup="true">
                    <a target="_blank" href=""
                       class="menu-link">
                        ...
                        <span class="menu-text"> السيرة الذاتية </span>
                    </a>
                </li>
                ...
                <li class="menu-item" aria-haspopup="true">
                    <a target="_blank" href="/"
                       class="menu-link">
                        ...
                        <span class="menu-text">عقد العمل </span>
                    </a>
                </li>

                <li class="menu-section">
                    <h4 class="menu-text">إدارة الطلبات </h4>
                    <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                </li>
                ...
                <li class="menu-section">
                    <h4 class="menu-text">إدارة مالية </h4>
                    <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                </li>
                ...
                <li class="menu-item" aria-haspopup="true">
                    ...
                    <a target="_blank" href="#"
                       class="menu-link">
                        ...
                        <span class="menu-text">رواتب </span>
                    </a>
                </li>
