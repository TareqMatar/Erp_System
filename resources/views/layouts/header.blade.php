...
<div id="kt_header" class="header header-fixed">
    ...
    <div class="container d-flex align-items-stretch justify-content-between">
        ...
        <div class="d-none d-lg-flex align-items-center mr-3">
            ...
            <!--begin::Logo-->
            <a href="/">
                <img alt="Logo" src="assets/media/logos/logo-icon.png" class="logo-sticky max-h-50px" />
            </a>
            <!--end::Logo-->
        ...
        <div class="topbar">
            ...
            <div class="topbar-item">
                <div class="btn btn-icon btn-sm btn-primary font-weight-bolder p-0" id="kt_quick_notifications_toggle">3
                </div>
            </div>
            <!--end::Notifications-->
        </div>
